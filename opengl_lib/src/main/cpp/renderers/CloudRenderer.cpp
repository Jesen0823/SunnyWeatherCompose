...
bool CloudRenderer::Init() {
    ...
    std::string vShaderStr = ShaderLoader::LoadShaderFromAssets("shaders/cloud_renderer_v.glsl");
    std::string fShaderStr = ShaderLoader::LoadShaderFromAssets("shaders/cloud_renderer_f.glsl");

    if (vShaderStr.empty()) {
        LOGCATE("CloudRenderer::Init: failed to load vertex shader");
        return false;
    }
    if (fShaderStr.empty()) {
        LOGCATE("CloudRenderer::Init: failed to load fragment shader");
        return false;
    }
